    ...
    struct RayTracedGiPass::Impl {
        ...
        explicit Impl(const RayTracedGiCreateInfo& createInfo)
            ...
            const nvrhi::ShaderHandle rayGeneration =
                shaders.loadRayTracingModule("rt_gi.rgen.spv", nvrhi::ShaderType::RayGeneration, "rayGenerationMain");
            const nvrhi::ShaderHandle radianceMiss =
                shaders.loadRayTracingModule("rt_gi.radiance.rmiss.spv", nvrhi::ShaderType::Miss, "radianceMissMain");
            const nvrhi::ShaderHandle shadowMiss =
                shaders.loadRayTracingModule("rt_gi.shadow.rmiss.spv", nvrhi::ShaderType::Miss, "shadowMissMain");
            const nvrhi::ShaderHandle closestHit =
                shaders.loadRayTracingModule(sharcEnabled ? "rt_gi.sharc.rchit.spv" : "rt_gi.rchit.spv",
