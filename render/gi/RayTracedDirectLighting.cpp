    ...
    struct RayTracedDirectLightingPass::Impl {
        ...
        explicit Impl(const CreateInfo& createInfo)
            ...
            const nvrhi::ShaderHandle rayGeneration =
                shaders.loadRayTracingModule("rt_di.rgen.spv", nvrhi::ShaderType::RayGeneration, "rayGenerationMain");
            const nvrhi::ShaderHandle radianceMiss =
                shaders.loadRayTracingModule("rt_di.radiance.rmiss.spv", nvrhi::ShaderType::Miss, "primaryMissMain");
            const nvrhi::ShaderHandle shadowMiss =
                shaders.loadRayTracingModule("rt_di.shadow.rmiss.spv", nvrhi::ShaderType::Miss, "shadowMissMain");
            const nvrhi::ShaderHandle closestHit =
                shaders.loadRayTracingModule("rt_di.rchit.spv", nvrhi::ShaderType::ClosestHit, "primaryClosestHitMain");
